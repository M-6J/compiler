...
public interface lab3Visitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	String visitConstInitVal(lab3Parser.ConstInitValContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#constExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitConstExp(lab3Parser.ConstExpContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	String visitInitVal(lab3Parser.InitValContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	String visitExp(lab3Parser.ExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#lVal}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitLVal(lab3Parser.LValContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#primaryExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitPrimaryExp(lab3Parser.PrimaryExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#addExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitAddExp(lab3Parser.AddExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#mulExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitMulExp(lab3Parser.MulExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#unaryExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitUnaryExp(lab3Parser.UnaryExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#funcRParams}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitFuncRParams(lab3Parser.FuncRParamsContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#add_Sub}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAdd_Sub(lab3Parser.Add_SubContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#mul_Div}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMul_Div(lab3Parser.Mul_DivContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab3Parser#number}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitNumber(lab3Parser.NumberContext ctx);
}