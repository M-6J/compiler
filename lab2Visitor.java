...
public interface lab2Visitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	String visitExp(lab2Parser.ExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab2Parser#addExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitAddExp(lab2Parser.AddExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab2Parser#add_Sub}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAdd_Sub(lab2Parser.Add_SubContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab2Parser#mulExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitMulExp(lab2Parser.MulExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab2Parser#mul_Div}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitMul_Div(lab2Parser.Mul_DivContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab2Parser#unaryExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitUnaryExp(lab2Parser.UnaryExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab2Parser#primaryExp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitPrimaryExp(lab2Parser.PrimaryExpContext ctx);
	/**
	 * Visit a parse tree produced by {@link lab2Parser#number}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	String visitNumber(lab2Parser.NumberContext ctx);
}